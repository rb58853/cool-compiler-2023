...
create_A_instance:
    ...
    syscall
    move $s0, $v0            # Guarda la dirección de la instancia de A en $s0
...
create_B_instance:
    ...
    li $a0, 8                # Tamaño de B
    syscall
    move $s1, $v0            # Guarda la dirección de la instancia de B en $s1
    ...
    move $t0, $v0
    sw $t0, 4($s1)           # Inicializa c con la dirección de la instancia de C
    jr $ra
...
create_C_instance:
    ...
    syscall
    move $s2, $v0            # Guarda la dirección de la instancia de C en $s2

    # Inicializar atributos de C
    la $t0, C_string         # Dirección de la cadena "c_string"
